...
function setup (){
    ...
    cannon = createSprite (560,600,100,100);
...
function bubbles (tamaño,x,y){
 ...
 function moveCannon (){
    ...
    if (keyIsDown ("39") && (cannon.rotation>=-70 && cannon.rotation<=110)){
        cannon.rotation += 10;
    }
    if (keyIsDown ("37")&&(cannon.rotation>=-70 && cannon.rotation<=110)){
        cannon.rotation -= 10;
    }

    if(cannon.rotation>110){
        cannon.rotation=110;
    }

    if(cannon.rotation <-70){
        cannon.rotation=-70;
    }
